...
MsCore::MsCore()
{
    ...
    THvRawFilter0 = new HvRawFilter(53,80.0,4600.0,false);//false -> LPF+HPF /* low pass filter and High pass filter */ for RX
    THvRawFilter0->set_rate(in_sample_rate);//2.76.2
    THvRawFilter0->set_lpf_hpf_parm(0.707,0.707);//2.76.3
    THvRawFilter1 = new HvRawFilter(53,80.0,4600.0,false);//4600.0
    THvRawFilter1->set_rate(fftw_sample_rate);//2.76.2
    THvRawFilter1->set_lpf_hpf_parm(0.707,0.707);//2.76.3
